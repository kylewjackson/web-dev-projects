...
console.log(`10/01/19: Hey, it's Kyle. Thanks for checking out my game! Just wanted to let you know if there is a warning in the Chrome dev console about createClass being deprecated, that's an issue with my use of create-react-app for my Product Page demo, which I'm looking into. It shouldn't be causing any issues.`); //Variables
...
function randomWoofs() {
  ...
  while (left > 0) {
    ...
    validWoofs.pets.push(validWoofs.pets.splice(randomBetween(0, left), 1)[0]); //decrease number left to shuffle
